...
import com.api.water.web.dao.PrescriptionDrugMapper;
...
@Service
@Transactional
public class PrescriptionDrugServiceImpl extends AbstractService<PrescriptionDrug> implements PrescriptionDrugService {
    @Resource
    ...
    public Result list(String search, String order, Integer page, Integer size){
        ...
        List<Map<String, Object>> res = prescriptionDrugMapper.baseList(params, orderParams);
