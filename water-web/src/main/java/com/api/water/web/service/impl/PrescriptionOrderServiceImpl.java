...
import com.api.water.web.dao.PrescriptionOrderMapper;
...
@Service
@Transactional
public class PrescriptionOrderServiceImpl extends AbstractService<PrescriptionOrder> implements PrescriptionOrderService {
    @Resource
    private PrescriptionOrderMapper prescriptionOrderMapper;
    ...
    public Result list(String search, String order, Integer page, Integer size){
        ...
        List<Map<String, Object>> res = prescriptionOrderMapper.baseList(params, orderParams);
