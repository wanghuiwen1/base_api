...
import com.api.water.web.dao.RefundApplyMapper;
...
@Service
@Transactional
public class RefundApplyServiceImpl extends AbstractService<RefundApply> implements RefundApplyService {
    @Resource
    ...
    public Result list(String search, String order, Integer page, Integer size){
        ...
        List<Map<String, Object>> res = refundApplyMapper.baseList(params, orderParams);
