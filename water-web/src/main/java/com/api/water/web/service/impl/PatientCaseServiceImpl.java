...
import com.api.water.web.dao.PatientCaseMapper;
...
@Service
@Transactional
public class PatientCaseServiceImpl extends AbstractService<PatientCase> implements PatientCaseService {
    @Resource
    ...
    public Result list(String search, String order, Integer page, Integer size){
        ...
        List<Map<String, Object>> res = patientCaseMapper.baseList(params, orderParams);
